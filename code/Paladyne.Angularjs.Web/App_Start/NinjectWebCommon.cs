...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Paladyne.Angularjs.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(Paladyne.Angularjs.Web.App_Start.NinjectWebCommon), "Stop")]
...
namespace Paladyne.Angularjs.Web.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<IDBFillerConfiguration>().ToConstant(Configuration.Instance);


            kernel.Bind<IUserStore<User>>().To<UserStore<User>>().InRequestScope();
            kernel.Bind<UserManager<User>>().To<UserManager<User>>().InRequestScope();
